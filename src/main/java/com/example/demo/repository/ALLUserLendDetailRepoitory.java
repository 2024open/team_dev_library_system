...
//	//CD詳細表示
//	static String sqlALLUserLendItemJoinCDDetail = "SELECT lend_item.lend_item_id,lend_item.library_id, cd.title,cd.author,cd.publisher,cd.genre_id,lend_item.status_id "
//			+ "FROM lend_item "
//			+ "INNER JOIN cd "
...
//	List<AllUserLendList> sqlALLUserCDLendJoinDetail(@Param("lendId") Integer lendId);
//
//	//DVD詳細表示
//	static String sqlALLUserLendItemJoinDVDDetail = "SELECT lend_item.lend_item_id,lend_item.library_id, dvd.title,dvd.author,dvd.publisher,dvd.genre_id,lend_item.status_id "
//			+ "FROM lend_item "
//			+ "INNER JOIN dvd "
...
//	List<AllUserLendList> sqlALLUserDVDLendJoinDetail(@Param("lendId") Integer lendId);
//
//	//紙芝居詳細表示
//	static String sqlALLUserLendItemJoinKamishibaiDetail = "SELECT lend_item.lend_item_id,lend_item.library_id, kamishibai.title,kamishibai.author,kamishibai.publisher,kamishibai.genre_id,lend_item.status_id "
//			+ "FROM lend_item "
...
//	List<AllUserLendList> sqlALLUserKamishibaiLendJoinDetail(@Param("lendId") Integer lendId);
}
